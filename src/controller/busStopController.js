        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        stop = req.query.stop;
                        url = "https://www.stcp.pt/pt/viajar/horarios/?paragem=".concat(stop, "&t=smsbus");
                    ...
                    case 1:
                        ...
                        url2 = "https://www.stcp.pt/pt/itinerarium/soapclient.php?codigo=".concat(linha, "&linha=0&hash123=").concat(hashCode);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        line = req.query.line;
                        dir = req.query.dir;
                        url = "https://www.stcp.pt/pt/itinerarium/callservice.php?action=linestops&lcode=".concat(line, "&ldir=").concat(dir);
                        return [4 /*yield*/, axios.get(url)];
                    case 1:
                        data = (_a.sent()).data;
                        res.json(data);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        line = req.query.line;
                        url = "https://www.stcp.pt/pt/itinerarium/callservice.php?action=linedirslist&lcode=".concat(line);
                        return [4 /*yield*/, axios.get(url)];
                    case 1:
                        data = (_a.sent()).data;
                        res.json(data);
